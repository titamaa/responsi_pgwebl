...
@section('content')
    ...
    <div class="modal fade" id="PolylineModal" tabindex="-1" aria-labelledby="PolylineModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="PolylineModalLabel"><i class="fa-solid fa-map-location-dot"></i> Create
                        Polyline</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="PolygonModal" tabindex="-1" aria-labelledby="PolygonModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="PolygonModalLabel"><i class="fa-solid fa-map-location-dot"></i>
                        Create Polygon</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
@section('script')
    ...
    <script>
        // Map
        var map = L.map('map').setView([-7.7242, 110.2987], 14); // Coordinates for Seyegan
      ...
      function getRandomColor() {
        ...
        /* Load GeoJSON */
fetch('storage/GeoJson/kelurahansyg.geojson')
    .then(response => response.json())
    .then(data => {
        L.geoJSON(data, {
            style: function(feature) {
                // Mendapatkan nilai NAMOBJ dari atribut
                var namobjValue = feature.properties.NAMOBJ;

                // Membuat objek warna berdasarkan nilai NAMOBJ
                var fillColor;
                switch (namobjValue) {
                    case 'Margomulyo':
                        fillColor = 'blue';
                ...
                return {
                    opacity: 1,
                    color: "black",
                    weight: 3, // Mengatur ketebalan garis menjadi 3
                    dashArray: '5, 5', // Menetapkan pola putus-putus
                    fillColor: fillColor // Menggunakan warna berdasarkan nilai NAMOBJ
                };
            },
            onEachFeature: function(feature, layer) {
                var content = "Kelurahan: " + feature.properties.NAMOBJ;
                layer.on({
                    click: function(e) {
        ...
        var polyline = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                var popupContent = "Nama: " + feature.properties.name + "<br>" +
                    ...
                    "<button type='submit' class='btn btn-danger' onclick='return confirm(`Apakah yakin untuk menghapus data inih?`)'><i class='fa-solid fa-trash-can'></i></button>"
